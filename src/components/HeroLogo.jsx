...
export default function HeroLogo() {
  ...
  useEffect(() => {
    ...
    tl.fromTo(
      ...
      ">-0.5" // empieza un poco antes de que termine el último trazo
    );
  }, []);

  return (
    <div className="w-[30rem] sm:w-[30rem] md:w-[25rem] lg:w-[35rem] object-cover rounded-full text-primary">
      <svg
        ref={svgRef}
